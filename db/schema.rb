...
ActiveRecord::Schema.define(version: 20170121222743) do
  ...
  create_table "banks", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.boolean  "plaid_needs_reauth", default: false
    t.index ["user_id"], name: "index_banks_on_user_id", using: :btree
  end

  create_table "dwolla_documents", force: :cascade do |t|
    t.string   "dwolla_id"
    t.uuid     "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_dwolla_documents_on_user_id", using: :btree
  end
  ...
  create_table "users", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at",                              null: false
    t.datetime "updated_at",                              null: false
    t.string   "dwolla_status"
    t.datetime "dwolla_verified_at"
